...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Piatto',
            fields=[
                ('id_piatto', models.IntegerField(primary_key=True, serialize=False)),
                ('nome', models.CharField(max_length=80)),
                ('descrizione', models.CharField(max_length=255, null=True)),
                ('prezzo', models.DecimalField(decimal_places=2, max_digits=10)),
                ('tipo_piatto', django_mysql.models.EnumField(choices=[('primo piatto', 'Primo'), ('secondo piatto', 'Secondo'), ('dessert', 'Dessert')])),
                ('id_responsabile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='piatto', to='mensa.responsabile')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_tavolo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prenotazione', to='mensa.tavolo')),
            ],
        ),
        migrations.CreateModel(
            name='Associazione',
            fields=[
                ...
                ('id_piatto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='associazione', to='mensa.piatto')),
                ('id_tavolo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='associazione', to='mensa.tavolo')),
            ],
        ),
    ]
